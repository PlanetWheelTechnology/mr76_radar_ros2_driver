...
class Mr76Driver {
 public:
  ...
  Mr76Driver();
  TargetData ParseTargetInfo(const can_msgs::msg::Frame &frame);
  int16_t ParseTotalObjects(const can_msgs::msg::Frame &frame);
  bool ExtractDetections(const can_msgs::msg::Frame &frame,
                         RadarData &radar_out);
};
