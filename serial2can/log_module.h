...
#define  LOG_DEBUG(format,...)   LOG_NO_DESCRI(LogModule::DEBUG_LEVEL,format,__VA_ARGS__)       
// #define  LOG_INFO(format,...)    LOG_NO_DESCRI(LogModule::INFO_LEVEL,format,__VA_ARGS__)        
// #define  LOG_WARN(format,...)    LOG_NO_DESCRI(LogModule::WARNING_LEVEL,format,__VA_ARGS__)     
// #define  LOG_ERROR(format,...)   LOG_NO_DESCRI(LogModule::ERROR_LEVEL,format,__VA_ARGS__)       
#else
#define  LOG_DEBUG(format,...)   do {} while(0)       
// #define  LOG_INFO(format,...)    do {} while(0)        
// #define  LOG_WARN(format,...)    do {} while(0)     
